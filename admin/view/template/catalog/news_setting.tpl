			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="input-description">Описание блога</label>
							<div class="col-sm-8">
							  <textarea name="news_setting[description_blog]" rows="5" placeholder="Описание блога" id="input-description" class="form-control summernote"><?php echo $description_blog; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label" for="input-seo">Сео текст</label>
							<div class="col-sm-8">
							  <textarea name="news_setting[seo_blog]" rows="5" placeholder="Сео текст" id="input-seo" class="form-control summernote"><?php echo $seo_blog; ?></textarea>
							</div>
						</div>
					</form>
				</div>
