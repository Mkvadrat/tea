...
class ControllerCatalogNews extends Controller {
	...
	public function setting() {
		...
		if (isset($news_setting['description_blog'])) {
			$data['description_blog'] = $news_setting['description_blog'];
		} else {
			$data['description_blog'] = '';
		}
		
		if (isset($news_setting['seo_blog'])) {
			$data['seo_blog'] = $news_setting['seo_blog'];
		} else {
			$data['seo_blog'] = '';
		}
